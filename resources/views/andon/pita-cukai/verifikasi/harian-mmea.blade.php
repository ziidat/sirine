<div class="card border-warning text-center">
  <div class="card-header"><h2>Hasil Verifikasi ( MMEA ) Hari Ini</h2></div>
    ...
    <DIV class="row">
      ...
      <div class="col-md-4">
        <div class="card bg-info text-center">
            ...
            <div class="card-body bg-white">
                <h1>{{ number_format($rusak_mmea) }}</h1>
            </div>
        </div>
      </div>
      <div class="col-md-4">
        <div class="card bg-info text-center">
            ...
            <div class="card-body bg-white">
                <h1>{{ number_format($inschiet_mmea,2) }} %</h1>
            </div>
        </div>
      </div>
    </DIV>
